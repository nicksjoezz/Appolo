...
Webflow.define('forms', module.exports = function ($, _) {
  ...
  function build(i, el) {
    ...
    data.done = wrap.find('> .w-form-done1');
    data.fail = wrap.find('> .w-form-fail1');
...
Webflow.require('ix').init([
  {"slug":"anim1","name":"anim1","value":{"style":{},"triggers":[{"type":"scroll","selector":".item-value","offsetBot":"10%","preserve3d":true,"stepsA":[{"opacity":1,"transition":"opacity 452ms ease 0, transform 2000ms ease 0","x":"72px","y":"0px","z":"0px","scaleX":1,"scaleY":1,"scaleZ":1}],"stepsB":[]}]}},
  {"slug":"aniim-online","name":"Aniim-online","value":{"style":{},"triggers":[{"type":"load","selector":".point","loopA":true,"stepsA":[{"opacity":0.24,"transition":"opacity 779ms ease 0"},{"opacity":1,"transition":"opacity 606ms ease 0"}],"stepsB":[]}]}}
]);
